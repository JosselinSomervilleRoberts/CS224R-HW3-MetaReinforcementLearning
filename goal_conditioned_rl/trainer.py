...
#         if her_type == HERType.FINAL:
#             # relabel episode based on final state in episode
#             final_goal = episode_experience[-1][-1]  # Get the final goal from the last transition
...
#                 random_goal = episode_experience[random_timestep][-1]  # Get the randomly selected goal
